                                    ...
                                    <InputOTPGroup className='grid grid-cols-6 gap-3'>
                                       {[0, 1, 2, 3, 4, 5].map((i) => (
                                          <InputOTPSlot
                                             key={i}
                                             index={i}
                                             className='h-12 w-12 rounded-xl border border-gray-300 bg-white text-lg font-semibold text-gray-800 shadow-sm transition-all focus:border-blue-500 focus:ring-2 focus:ring-blue-200 data-[active=true]:border-blue-600 data-[active=true]:ring-2 data-[active=true]:ring-blue-300'
                                          />
                                       ))}
                                    </InputOTPGroup>
                                 </InputOTP>
